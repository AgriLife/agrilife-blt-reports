...
class Templates_Quarterly_Reports {
	...
	public function get_archive_template( $archive_template ) {
		...
		if ( is_post_type_archive( 'quarterly-reports' ) ) {
			$archive_template = AG_BLT_TEMPLATE_PATH . '/archive-quarterlyreports.php';
		}
	...
	public function get_single_template( $single_template ) {
		...
		if ( get_query_var( 'post_type' ) == 'quarterly-reports' ) {
			$single_template = AG_BLT_TEMPLATE_PATH . '/single-quarterlyreport.php';
		}
